...
-- automate backend of the database
-- DELIMITER $$ to change mysql ; delimiter into $$ 
-- to differentiate sql staments inside trigger with end of trigger
DELIMITER $$
CREATE
...
SELECT * FROM trigger_test;
 ...
 -- to get firstname of employee being inserted 
DELIMITER $$
CREATE
...
-- we can also write IF ELSEIF ELSE END IF; inside sql
